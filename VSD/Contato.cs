...
public class Contato
{
    ...
    public static void MenuContatos(List<string> contatos)
    {
        ...
        Digite 3 para exibir os contatos cadastrados em ordem descrescente");
    ...
    public static void ListarContatos(List<string> contatos)
    {
        ...
        {
            Console.WriteLine("Nº"+ (i+1) +" - "+ contatos[i]);   
        }
    }

     public static void ListarContatosDecrescente(List<string> contatos)
    {
        Console.WriteLine("------ Lista de Contatos Decrescente ------");
    ...
    {
        Console.WriteLine("------ Lista de Contatos Ordem Alfabetica ------");
